...
public class PlaybackControlView extends FrameLayout {
  ...
  private final View fullscreen_button;
  ...
  public PlaybackControlView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    fullscreen_button = findViewById(R.id.exo_fullscreen_button);
    if (fullscreen_button != null) {
      fullscreen_button.setOnClickListener(componentListener);
    }
  ...
  public void setFullScreenClickListener(OnFullScreenClick mOnFullScreenClick) {
    this.mOnFullScreenClick = mOnFullScreenClick;
  }
  ...
  private void fullScreen() {
    ...
    if (mOnFullScreenClick != null) {
      mOnFullScreenClick.onFullScreenClick();
    }
//
//    if (fastForwardMs <= 0) {
//      return;
  ...
  private final class ComponentListener implements ExoPlayer.EventListener,
    ...
    public void onClick(View view) {
      if (player != null) {
        ...
        else if (fullscreen_button == view) {
          fullScreen();
        }
      }
      hideAfterTimeout();
