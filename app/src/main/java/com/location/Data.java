...
public class Data {
    ...
    public SpannableString getDistance() {
        SpannableString s;
        if (distanceKm < 1) {
            s = new SpannableString(String.format(Locale.US, "%.0f", distanceM) + "m");
            s.setSpan(new RelativeSizeSpan(0.5f), s.length() - 1, s.length(), 0);
        } else {
            s = new SpannableString(String.format(Locale.US, "%.3f", distanceKm) + "Km");
    ...
    public SpannableString getMaxSpeed() {
        SpannableString s = new SpannableString(String.format(Locale.US, "%.0f", maxSpeed) + "km/h");
    ...
    public SpannableString getAverageSpeed() {
        ...
        SpannableString s;
        if (time > 0) {
            s = new SpannableString(String.format(Locale.US, "%.0f", average) + "km/h");
    ...
    public String getAverageSpeedInFloat() {
        ...
        SpannableString s;
        if (time > 0) {
            s = new SpannableString(String.format(Locale.US, "%.0f", average) + "");
